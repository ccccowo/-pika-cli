...
function getGithubToken() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        while (!isValid) {
            ...
            const { validateToken } = yield import('@pika-cli/github');
...
function create() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        // 询问是否创建 GitHub 仓库
        const createGithubRepo = yield select({
        ...
        if (createGithubRepo) {
            ...
            const { createGithubRepo } = yield import('@pika-cli/github');
