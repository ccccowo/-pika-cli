...
hoistedDependencies:
  ...
  packages/cli:
    '@pika-cli/cli': private
  packages/cli-service:
    '@pika-cli/cli-service': private
  packages/create:
    '@pika-cli/create': private
  packages/generate:
    '@pika-cli/generate': private
  packages/github:
    '@pika-cli/github': private
  packages/template-react-ui-ts:
    '@pika-cli/template-react-ui-ts': private
  packages/utils:
    '@pika-cli/utils': private
  pacote@15.2.0:
    pacote: private
  parent-module@1.0.1:
...
prunedAt: Wed, 22 Jan 2025 05:34:24 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
...
skipped:
  ...
  - '@rollup/rollup-win32-ia32-msvc@4.29.1'
  - '@rollup/rollup-win32-x64-msvc@4.29.1'
storeDir: /Users/chensihong02/Library/pnpm/store/v3
