...
hoistedDependencies:
  ...
  '@inquirer/number@3.0.8(@types/node@20.17.18)':
    '@inquirer/number': private
  '@inquirer/password@1.1.16':
    '@inquirer/password': private
  '@inquirer/prompts@7.3.1(@types/node@22.13.2)':
    '@inquirer/prompts': private
  '@inquirer/rawlist@1.2.16':
    '@inquirer/rawlist': private
  '@inquirer/search@3.0.8(@types/node@20.17.18)':
  ...
  packages/server:
    '@pika-cli/server': private
  packages/types:
    '@pika-cli/types': private
  packages/utils:
    '@pika-cli/utils': private
  packages/web:
    '@pika-cli/web': private
  pacote@15.2.0:
    pacote: private
  pako@1.0.11:
    pako: private
  ...
  vfile@6.0.3:
    vfile: private
  vite-plugin-node-polyfills@0.23.0(rollup@4.34.6)(vite@5.4.14(@types/node@22.13.2)):
...
pendingBuilds: []
prunedAt: Tue, 04 Mar 2025 12:01:44 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
...
virtualStoreDir: D:\前端\个人项目\-pika-cli\node_modules\.pnpm
