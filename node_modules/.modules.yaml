...
hoistedDependencies:
  ...
  /@rollup/plugin-babel/6.0.4(@babel/core@7.26.0)(rollup@4.29.1):
    '@rollup/plugin-babel': private
  /@rollup/plugin-commonjs/28.0.2(rollup@4.29.1):
    '@rollup/plugin-commonjs': private
  /@rollup/plugin-typescript/12.1.2(rollup@4.29.1)(typescript@5.7.2):
...
pendingBuilds:
  ...
  - /esbuild/0.21.5
  - /@esbuild/darwin-x64/0.21.5
prunedAt: Fri, 20 Dec 2024 08:15:42 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
